...
################################################
LIBS += -lcx_net_sockets -lcx_mem_streams -lcx_net_threadedacceptor -lcx_net_chains -lcx_net_chains_tls -lcx_net_tls -lssl -lcrypto -lpthread

TARGET = cx_aeschat_server
